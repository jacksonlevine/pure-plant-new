...
export default function Testimonials({ testimonials }:TestimonialsArg) {
    ...
    return (
        <div className="flex flex-col justify-center items-center xl:max-w-2xl w-full animate-fi z-20">
            <div className="bg-white/30 w-fit backdrop-blur-md rounded-lg p-6 border transition-all z-20 duration-300 hover:bg-white/20 hover:scale-105 border-white/20 min-h-32 flex flex-col justify-center w-full xl:min-w-[28rem]">
                <p className="text-lg italic mb-3">"{testimonials[currentTestimonial].text}"</p>
